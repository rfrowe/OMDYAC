...
mail("redacted@address.com","500 Internal Server Error","http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']);
?>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />

	<title>OMD YAC • 500: Internal Server Error</title>
		...
		<div id="main">
			...
			<div id="content">
				...
				<?php
					...
					echo "\t</div> <!-- end date -->\n";
					echo "\t<h2 class='con-detail'><a href='/'>500: Internal Server Error</a></h2>\n\n";

					echo "\t\t<div class='post_data'>\n\t\t<span class='categories'>&nbsp;</span>\n\t\t<span class='author'></span>\n\t\t</div> <!-- end post data -->\n";

					echo "\t\t<span class='desc'><p>Uh oh... The website had a problem<br/>
					An email has been sent to the webmaster about this and it will be resolved as quickly as possible</p>
					In the meantime, please enjoy videos of a kitten trying to climb up a slide<br/><br/>
					<iframe width='480' height='360' src='http://www.youtube.com/embed/gppbrYIcR80' frameborder='0' allowfullscreen></iframe>
					";
					echo "</div> <!-- end entry -->";
