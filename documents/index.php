...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
	...
	<title>OMD YAC &bull; Documents</title>
			...
			<div id="content">
				...
				<div class='entry'>
                    ...
                    <h3>Con Forms</h3>
						...
						$mysql = new MySQL_Utilities;
						$mysql->connect("omdyac");
						$mysql->select("documents","*","con = 1");

						$conDocs = $mysql->getResult();

						?>
                  <table width="100%" border="1" rules="all">
                			<tr><th style="background: #555; color: #FFF;" colspan="2" id='conForms'>Con Forms</th></tr>
                            <?php

							foreach($conDocs as $document):
								echo "<tr><td><a href='".$document['Link']."' target='_blank'>".$document['Name']."</a></td><td>".$document['Description']."</td></tr>";
							endforeach;
						...
						$mysql = new MySQL_Utilities;
						$mysql->connect("omdyac");
						$mysql->select("documents","*","con = 0");

						$docs = $mysql->getResult();

						?>
                  <table width="100%" border="1" rules="all">
                			<tr><th style="background: #555; color: #FFF;" colspan="2" id='docs'>Documents</th></tr>
                            <?php
						...
						$minutes = $mysql->getResult();

						?>
                  		<table width="100%" border="1" rules="all">
                			<tr><th style="background: #555; color: #FFF;" colspan="2" id='mins'>Minutes</th></tr>
                            <?php

							foreach($minutes as $min):
								echo "<tr><td><a href='minutes/".$min['Link']."' target='_blank'>".$min['Name']."</a></td><td width='30px' style='text-align: center;'>".$min['Year']."</td></tr>";
							endforeach;
