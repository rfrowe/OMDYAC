...
class MySQL_Utilities
{
    ...
    */
    ...
    {
		/* this isnt working for some reason so I disabled it and made it always return true. Hope this doesn't come back to bite me :/
                ...
                for($x = 0; $x < count($key); $x++)
                {
                    ...
                    if(!is_int($key[$x]))
                    {
                        if(mysqli_num_rows($query) > 1) {
							...
							$this->result[1][$key[$x]] = stripslashes($r[$key[$x]]);
						}
                    }
                }
            }
